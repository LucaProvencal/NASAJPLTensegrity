...
void T6Model::addNodes(tgStructure& s)
{
    ...
    // s.addNode(0,  half_length, 0);  // 13. additional node for figuring out what rod_space is
}
...
void T6Model::addRods(tgStructure& s)
{
    ...
    // Payload
    // s.addPair(12, 11, "payload_sphere");
...
void T6Model::setup(tgWorld& world)
{
    ...
    const tgSphere::Config payConfig(c.radius_pay, c.density_pay, c.friction,
                c.rollFriction, c.restitution);
